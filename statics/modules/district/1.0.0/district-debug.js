	...
	module.exports = function(opts) {
		...
		function init() {
			...
			if (!option.display) {
				...
				option.display(_elm2, 'none');
				option.display(_elm3, 'none');
			}
			// 初始化省份下拉框
		...
		function c1(opt, code) {
			var r1 = code, o = $id(opt.ids[1]), _rd = data;
			o.options.length = 0;
			if (typeof _rd[r1] == "object" && _rd[r1].length > 1 && !isEmptyObject(_rd[r1][1])) {
				...
				if (!option.display) {
					...
					option.display(o, 'none');
					option.display($id(opt.ids[2]), 'none');
				}
			}
			o = null;
		}
		...
		function c2(opt, code) {
			var r1 = $id(option.ids[0]).value, r2 = code, o = $id(opt.ids[2]), _rd = data;
			o.options.length = 0;
