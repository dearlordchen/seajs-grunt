 ...
 * @description  
 */
define("common/imgselector", [ "jquery/jquery", "common/dialog", "common/float", "common/tplparser", "common/fun", "common/floatmask", "common/loadscript", "common/page" ], function(require, exports, module) {
    "use strict";
    var $ = require("jquery/jquery"), _dialog = require("common/dialog"), _template = require("common/tplparser"), _load = require("common/loadscript"), _page = require("common/page"), _baseFun = require("common/fun"), _config = {
