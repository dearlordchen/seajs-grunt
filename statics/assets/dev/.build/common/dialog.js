 ...
 * @description  
 */
define("common/dialog", [ "jquery/jquery", "common/float", "common/tplparser", "common/fun", "common/floatmask" ], function(require, exports, module) {
    "use strict";
    var $ = require("jquery/jquery"), _float = require("common/float"), _template = require("common/tplparser"), _baseFun = require("common/fun"), _floatmask = require("common/floatmask"), _config = {
