define("easyhin/register/1.0.0/register-debug", [ "jquery-debug", "easyhin/common/1.0.0/common-debug.js" ], function(require, exports, module) {
    ...
    var REG = {
        ...
        bindEvent: function() {
            ...
            vc.blur(function() {
                ...
                } else if ($.trim($(this).val()).length != 4) {} else {
                    $(this).css({
                        borderColor: "#7abd54"
                    });
                }
        ...
        verifyMail: function(mail) {
            if (/^([a-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\-]+\.)+[a-z]{2,6}$/gi.test(mail)) {
                return true;
            }
            return false;
        },
        ...
        charMode: function(iN) {
            ...
            if (iN >= 97 && iN <= 122) return 4; else return 8;
        },
