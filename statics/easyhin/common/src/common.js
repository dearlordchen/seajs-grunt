define(function(require, exports, module) {
	...
	exports.cm = {
		...
		dialog : {
			tpl : '<div style="padding:5px;background:rgba(0,0,0,.4);filter:progid:DXImageTransform.Microsoft.Gradient(startColorStr=#64000000,endColorStr=#64000000);width:360px;height:160px;">\
				<dl style="float:left;width:100%;height:100%;background:#fff;">\
				<dt style="font-size:14px;font-weight:700;height:35px;line-height:35px;background:#fff;border-bottom:1px solid #e9e9e9;padding:0 8px;color:#333;">\
				<a mod="btn-close" href="javascript:;" style="float:right;color:#999;text-decoration:none;height:16px;width:16px;line-height:14px;font-size:20px;position:relative;top:10px;">×</a>\
				<span mod="title">提示</span></dt>\
				<dd style="float:left;height:90px;width:100%;">\
				<p mod="content" style="text-align:center;height:60px;padding-top:30px;font-size:14px"></p>\
				</dd>\
				<dd style="float:left;width:100%;height:34px;text-align:right;"><a style="margin-right:10px;height:24px;line-height:24px;" href="javascript:;" mod="sure" class="btn btn-yellow">确定</a>\
				</dd></dl></div>',
			...
			loading : function(msg) {
				...
				this.popup('_loading_dialog', tpl, true, function(tpl) {
				}, function(tpl) {
				});
			},
